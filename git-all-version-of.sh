...
then
  ...
  echo 
  echo "path/to/somefile.txt.001.0dea419"
  echo "path/to/somefile.txt.001.0dea419.logmsg"
  echo "path/to/somefile.txt.002.cdea8s9"
  echo "path/to/somefile.txt.002.cdea8s9.logmsg"
  echo "path/to/somefile.txt.003.fdsf2d"
  echo "path/to/somefile.txt.003.fdsf2d.logmsg"
  echo "..."
  exit 1
fi
